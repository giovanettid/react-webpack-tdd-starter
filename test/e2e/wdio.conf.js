...
exports.config = {
  ...
  cucumberOpts: {
    ...
    tags: [], // <string[]> (expression) only execute the features
    // or scenarios with tags matching the expression
    timeout: 20000, // <number> timeout for step definitions
    ignoreUndefinedDefinitions: false, // <boolean> Enable this config
    // to treat undefined definitions as warnings.
  },
  //
  // =====
  // Hooks
  ...
  // If one of them returns with a promise,
